      ...
      <div className="container">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[hsl(var(--text-muted))] max-w-3xl mx-auto">
            Si buscas una referencia puntual o quieres comparar opciones, te ayudamos a elegir sin
            enredos.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Pide tu cotizacion</h3>
            ...
            <form className="space-y-6">
              ...
              <div>
                <Label htmlFor="product" className="text-sm font-medium text-gray-700 mb-2 block">
                  Producto de Interés
                </Label>
                <Input
                  id="product"
          ...
          <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Te ayudamos con disponibilidad, precio y compatibilidad
                    </p>
                  </div>
                </a>
              </div>
            ...
            {/* Store Info */}
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Atencion y cobertura</h3>
