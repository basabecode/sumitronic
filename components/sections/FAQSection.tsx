      ...
      <div className="container">
        ...
        <div id="no-encontraste" className="mt-12 text-center">
          <div className="rounded-2xl bg-gradient-to-r from-[hsl(var(--surface-highlight))] to-[hsl(var(--background))] p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">¿Todavia tienes dudas?</h3>
            <p className="text-gray-600 mb-6">
              Escribenos y te orientamos segun el producto, el presupuesto o el tipo de uso que
              tienes en mente.
            </p>
