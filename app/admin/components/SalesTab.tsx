...
export default function SalesTab() {
  ...
  const fetchOrders = async () => {
    setLoading(true)
    try {
      // Fetch orders with user details if possible (though customer_info JSONB usually has what we need)
      ...
      if (data) {
        setOrders(data as unknown as Order[]) // Type assertion as structure matches
      }
    } catch (error) {
