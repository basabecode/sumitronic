            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Te enviaremos un email de confirmación con todos los
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Nuestro equipo preparará tu pedido cuidadosamente para el
                    envío.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Recibirás un código de seguimiento cuando tu pedido sea
                    despachado.
                  </p>
                </div>
              </div>
