...
export const metadata: Metadata = {
  ...
  description:
    `${brand.name} es una tienda en Cali especializada en cámaras de seguridad, redes, UPS y repuestos para TV. Atención directa, marcas con respaldo y envíos a toda Colombia.`,
  keywords: [
  ...
  openGraph: {
    ...
    description:
      `Tienda en Cali especializada en seguridad electrónica, conectividad y repuestos con atención cercana y envíos a toda Colombia.`,
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-[hsl(var(--text-muted))]">
                {brand.name} nació en Cali como respuesta a un problema concreto: comprar equipos de seguridad en Colombia sin saber bien qué se está comprando. Muchos vendedores ofrecen mucho y explican poco. Nosotros hacemos lo contrario.
              </p>
              <p className="mt-4 text-lg leading-8 text-[hsl(var(--text-muted))]">
                Nos especializamos en seguridad electrónica, redes, respaldo eléctrico y repuestos para televisores. No vendemos de todo: vendemos lo que sabemos respaldar.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <div className="mt-5 space-y-4 text-base leading-7 text-[hsl(var(--text-muted))]">
                <p>
                  Antes de poner un equipo en el catálogo, lo conocemos. Sabemos qué hace bien, en qué falla y para qué tipo de cliente tiene sentido. Eso nos permite orientar mejor cada compra.
                </p>
                <p>
                  Atendemos por WhatsApp para cotizar, resolver dudas técnicas y confirmar disponibilidad. No tenemos bots: cuando escribe, le responde una persona del equipo.
                </p>
                <p>
                  Despachamos a toda Colombia. Para clientes en Cali, también ofrecemos recogida en tienda y, en algunos casos, orientación técnica presencial.
                </p>
              </div>
              ...
              {valores.map((valor) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mb-2 font-semibold text-[hsl(var(--foreground))]">{valor.title}</h3>
                    <p className="text-sm leading-6 text-[hsl(var(--text-muted))]">{valor.description}</p>
                  </div>
                )
              })}
            </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-base text-[hsl(var(--text-muted))]">
              No tenemos un catálogo de miles de referencias genéricas. Trabajamos con marcas reconocidas y sabemos cómo funciona cada una.
            </p>
          </div>
        ...
        <section className="border-t border-[hsl(var(--border-subtle))] bg-gradient-to-r from-[hsl(var(--brand-strong))] to-[hsl(var(--brand))] py-14">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            ...
            <p className="mt-3 text-base text-sky-100">
              Cuéntenos qué necesita. Le ayudamos a elegir la solución correcta sin necesidad de comprar más de lo que su caso requiere.
            </p>
