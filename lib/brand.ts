export const brand = {
  ...
  siteUrl: 'https://sumitronic.com',
  logoUrl: 'https://sumitronic.com/logos/logo_sumitronic_3.png',
  faviconUrl: 'https://sumitronic.com/favicon.png',
  ...
  socialLinks: ['https://instagram.com/sumitronic.co', 'https://facebook.com/sumitronic.co'],
